...
public class ChessMatch {
	...
	public ChessPiece performChessMove(ChessPosition sourcePosition, ChessPosition targetPosition) {
		...
		if(movedPiece instanceof Pawn) {
			if(movedPiece.getColor() == Color.WHITE && target.getRow() == 0 || movedPiece.getColor() == Color.BLACK && target.getRow() == 7) {
				...
				this.promoted = replacePromoredPiece("Q");
			}
		}
	...
	public ChessPiece replacePromoredPiece(String type) {
		if(promoted == null) {
			throw new IllegalStateException("não há peça a ser promovida");
		}
		if(!type.equals("B") && !type.equals("N") && !type.equals("R") && !type.equals("Q")) {
			throw new InvalidParameterException("tipo inválido para promovido");
		}
	...
	private void validateSourcePosition(Position position) {
		...
		if(!board.piece(position).isThereAnyPossibleMove()) {
			throw new ChessException("Não existem movimentos posiveis para a peça escolhida");
		}
	}
